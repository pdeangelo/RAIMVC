namespace RAI_MVC.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<RAI_MVC.Context>
    {
        
        public Configuration()
        {
            AutomaticMigrationsEnabled = false;
            ContextKey = "RAI_MVC.Context";
        }

        protected override void Seed(RAI_MVC.Context context)
        {
